...
def frequencyAnalizer( input ):
    ...
    plotSpectrum(frequencySpectrumX,frequencySpectrumY)


# frequencyAnalizerMethod():
...
def menu():
    ...
    cipherText=input()
    print("----------------------------------")
    frequencyAnalizer(cipherText)
    frequencyAnalizer(sampleA)
    # key=frequencyAnalizerMethod(cipherText)
    print("----------------------------------")
